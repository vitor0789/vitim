document.addEventListener('DOMContentLoaded', function() {
    ...
    link.rel = 'icon';
    link.href = 'i/logo.png'; // Certifique-se de que o caminho está correto
    ...
    const menuItems = [
        ...
        { name: 'História do Racismo', subItems: [
            ...
            { name: 'Colonização', link: 'colonização.html' } // Corrigi a acentuação do link
        ]},
        ...
        { name: 'Combate ao Racismo', subItems: [
            ...
            { name: 'Educação e Conscientização', link: 'edu.html' } // Corrigi o espaço e acentuação
        ]},
        { name: 'Bonus', subItems: [
            { name: 'Imagens Geradas por IA', link: 'imagens_ia.html' },
            { name: 'videos', link: 'aulas.html' } // Corrigi o espaço e acentuação
        ]},
    ];
